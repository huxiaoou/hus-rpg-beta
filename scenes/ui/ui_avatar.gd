...
@onready var ui_bar_health: UIDualProgressBar = $HBoxInfo/Bg/HBox/VBoxBars/Row0/UIBarHealth
@onready var ui_bar_magicka: UIDualProgressBar = $HBoxInfo/Bg/HBox/VBoxBars/Row0/UIBarMagicka
@onready var ui_bar_resolve: UIDualProgressBar = $HBoxInfo/Bg/HBox/VBoxBars/Row1/UIBarResolve
@onready var ui_bar_stamina: UIDualProgressBar = $HBoxInfo/Bg/HBox/VBoxBars/Row1/UIBarStamina
